...
class Property(models.Model):
    ...
    front_image = models.ImageField(upload_to='property_cover_images/', blank=True, null=True, default= True)
    back_image = models.ImageField(upload_to='property_cover_images/', blank=True, null=True, default= True)
...
class Reservation(models.Model):
    ...
    customer = models.ForeignKey(User, on_delete=models.CASCADE, related_name='owned_reservations')
    owner = models.ForeignKey(User, on_delete= models.CASCADE, related_name='booked_reservations')
